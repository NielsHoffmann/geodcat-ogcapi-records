...
# DCAT-AP 3.0.0 profile (Model)

`ogc.geo.geodcat.dcat-ap-3.0.0` *v0.3*
...
### DCAT-AP 3.0.0 example
This is an example conforming to DCAT-AP 3.0.0
...
### DCAT-AP 3.0.1 example
This is an example conforming to DCAT-AP 3.0.1, so it is expected to fail validation against the DCAT-AP 3.0.0 SHACL shapes.
The example shows multiple rights statements, which is not allowed in DCAT-AP 3.0.0.
#### ttl
```ttl
...
exampleMS:1T2p3o4B-dist-SHP a dcat:Distribution ;
  ...
  dct:conformsTo <http://inspire.ec.europa.eu/schemas/hy/4.0/HydroBase.xsd> ;
  dcat:mediaType <https://www.iana.org/assignments/media-types/application/vnd.shp>;
  dct:rights <http://publications.europa.eu/resource/authority/access-right/NON_PUBLIC>;
  dct:rights <http://publications.europa.eu/resource/authority/access-right/SENSITIVE>
  .
...
<http://publications.europa.eu/resource/authority/access-right/SENSITIVE> a dct:RightsStatement .
...
* [DCAT-AP 3.0.0 Specification](https://semiceu.github.io/DCAT-AP/releases/3.0.0/)
* [DCAT-AP 3.0.0 JSON-LD context](https://semiceu.github.io/DCAT-AP/releases/3.0.0/context/dcat-ap.jsonld)
