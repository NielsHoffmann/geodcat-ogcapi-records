...
# DCAT-AP 3.0.1 profile (Model)

`ogc.geo.geodcat.dcat-ap-3.0.1` *v0.1*
...
This is an example conforming to DCAT-AP 3.0.1
...
* [DCAT-AP 3.0.1 JSON-LD context](https://semiceu.github.io/DCAT-AP/releases/3.0.1/context/dcat-ap.jsonld)
